...
int smk_enable_all(smk object, unsigned char mask);
int smk_enable_video(smk object, unsigned char enable);
int smk_enable_audio(smk object, unsigned char track, unsigned char enable);
...
int smk_first(smk object);
/** advance to next frame and unpack */
int smk_next(smk object);
/** seek to first keyframe before/at N in an smk */
int smk_seek_keyframe(smk object, unsigned long frame);
